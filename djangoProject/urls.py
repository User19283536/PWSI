...
urlpatterns = [
    ...
    path('discover/', views.offers, name = "discover"),
    ...
    re_path(r'^discover/purchase$', views.orders, name = "purchase"),
    path('discover/purchased', views.ordered, name="purchased"),
    ...
    path('offerAdded', views.offerAdded, name="offerAdded")
]
